        ...
        onSuccess: function (e) {
			...
			*/
			...
			$.post('script/buscarUsuario.php', {rut:rut}, function(res){
				...
				if(usuario['rut']==null){
					$.post('script/agregarUsuario.php', {jsonUsuario:jsonUsuario}, function(resA){
						if (resA =='4'){
							opener.actualizarDatosChequeCheque(rut,nombres); //funcion opener para llegar al padre y actualizar médoto contenido en el padre
